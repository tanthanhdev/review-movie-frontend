                    ...
                    <ul className="header__menu-items">
                        <li className="header__menu-item header__menu-item-category">
                            ...
                            <ul className="header__menu-nav .header__menu-col-5 header__menu-nav-category">
                                ...
                                <li className="header__menu-nav-item">
                                    <a href="filter?genre=Action" className="header__menu-nav-link">Phim viễn tưởng</a>
                                </li>
                                <li className="header__menu-nav-item">
                                    <a href className="header__menu-nav-link">Phim phổ  biến</a>
                                </li>
                                <li className="header__menu-nav-item">
                                    <a href className="header__menu-nav-link">Phim sắp chiếu</a>
                                </li>
                            </ul>
                        </li>
