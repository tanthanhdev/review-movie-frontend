...
export default function Filter() {
    ...
    const getMovie = (page, page_size, genre, english_name, release_date) => {
        PublicMovieService.getPagination(page, page_size, genre, english_name, release_date)
        .then(response => {
    ...
    useEffect(() => {
        if (value.genre === "Popular") {
            ...
            getMovie(page, pageSize, value.genre, value.country);
        }
    }, [value, pageSize]);
